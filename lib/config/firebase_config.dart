...
const androidClientID = "347111752310-5d1q0kvkpv34pnvjlm3sepa8dakgeh9k.apps.googleusercontent.com";
const iosClientID = "347111752310-tkh0280494mrj413rpvuu9ifnvb2976o.apps.googleusercontent.com";
const projectId = "bapp-production";
const storageBucket = "bapp-production.appspot.com";
const messagingSenderID = "347111752310";


Future initFirebase({bool production=false}) async {
  if(production){
    Helper.printLog("using bapp-production firebase project");
    return _bappProductionFirebaseProjectInitialization();
  }
  Helper.printLog("using bapp-dev firebase project");
