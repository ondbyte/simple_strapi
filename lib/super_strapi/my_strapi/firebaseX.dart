...
Future loginOrSignUpWithNumber({
  ...
  await fba.FirebaseAuth.instance.verifyPhoneNumber(
    ...
    verificationCompleted: (PhoneAuthCredential phoneAuthCredential) async {
      ...
      await _processCredential(phoneAuthCredential, number.internationalNumber);
      onVerified?.call();
    },
...
Future<bool> _processCredential(
    AuthCredential phoneAuthCredential, String number) async {
...
Future<bool> _link(AuthCredential phoneAuthCredential) async {
  try {
