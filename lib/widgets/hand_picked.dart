...
class HandPickedScroller extends StatefulWidget {
  ...
  HandPickedScroller({Key? key, required this.city, required this.locality})
      : super(key: key);
...
class _HandPickedScrollerState extends State<HandPickedScroller> {
  ...
  Widget build(BuildContext context) {
    return TapToReFetch<List<HandPicked>>(
      fetcher: () => HandPickedX.i.getAll(widget.city, widget.locality),
                ...
                onPicked: () {
                  BappNavigator.push(
                    ...
                    BranchesResultScreen(
                      ...
                      title: list[i].name ?? "",
                      placeName:
                          widget.locality?.name ?? widget.city?.name ?? "",
                    ),
                  );
                },
              );
