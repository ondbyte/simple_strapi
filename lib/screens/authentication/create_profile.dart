                ...
                PrimaryButton(
                  ...
                  onPressed: () {
                    if (_key.currentState.validate()) {
                      ...
                      Provider.of<AuthStore>(context,listen: false).updateProfile(
                        displayName: _name,
                        email: _email,
                        onSuccess: (){
                        ...
                        onFail: (e){
                          ...
                          switch (e.code){
                            case "invalid-email":{
                              Flushbar(message: "The email is invalid",duration: const Duration(seconds: 2),).show(context);
                              break;
                            }
                            case "email-already-in-use":{
                              Flushbar(message: "The email is already in use",duration: const Duration(seconds: 2),).show(context);
                              break;
                            }
                            case "requires-recent-login":{
                              Navigator.of(context).pushReplacementNamed(RouteManager.loginScreen);
                              break;
                            }
                          }
                        }
